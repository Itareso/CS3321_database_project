	...
	<body>
			...
			<div class="container">
				...
				<div class="navbar-collapse collapse" id="navbarColor02" style="">
					<ul class="navbar-nav mr-auto d-flex align-items-center">
						...
						<li class="nav-item">
							<a class="nav-link" href="./searchresult"
								style="font-weight: none; font-size: 15px">Search</a>
						</li>
					</ul>
		...
		<div class="container resize">
			...
			<form id="signupForm">
				...
				<div class="cf-turnstile" data-sitekey="0x4AAAAAAAOBU1BK4T3OQONj" data-callback="javascriptCallback">
				</div>
				...
				<div class="container2">
					<div class="button-with-text">
						<button type="button" class="btn btn-outline-primary btn_circle_signup"
							:class="{ btn_circle_signup_active: this.agreed }" @click="changeAgreement">
				...
				<div class="submit_button">
					<button type="submit" class="btn btn-primary submit_btn_longer"
						:disabled="!this.agreed">Submit</button>
				</div>
		...
		<div v-if="isPopoverVisible" class="fullscreen-popover">
			<div class="popover-content">
				<p><strong>隐私政策：</strong>
					欢迎您使用我们的服务。我们很重视您的隐私，除非触及需要花费我们额外的成本<br>
					...
					我们会视对方报价出售您的信息。<br>
					■ 信息的保护<br>
					我们将尽量采取一些免费的安全措施来保护您的个人信息，一旦需要花费额外成本我们会毫不犹豫地放弃。<br>
				</p>
				...
				<div class="row justify-content-center">
					<div class="col-12">
						<h3 class="middle_title">
							<img src="../assets/img/bookhub.png" width="150">
						</h3>
					</div>
				</div>
			</div>
	...
	methods: {
		async initialize() {
			...
			document.getElementById('signupForm').addEventListener('submit', function (event) {
				...
				// fetch('http://10.80.158.19:8088/api/v1/user/signup', {
				fetch('http://10.80.158.19:8088/api/v1/user/signup', {
					method: 'POST',
					body: formData
				})
		...
		register() {
			axios.get("http://10.80.158.19:8088/api/v1/user/signup", {
				params: {
